  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        <a href="#" title class="c-999 fsize14">{{courseWebVo.oneSubject}}</a>
        <span class="c-333 fsize14">{{courseWebVo.twoSubject}}</span>
      </section>
      <div>
...
export default {
  ...
  methods: {
     ...
     initCourseInfo() {
        courseApi.getCourseInfo(this.courseId)
          ...
          console.log(response)
            this.courseWebVo=response.data.data.baseCourse,
            this.chapterVideoList=response.data.data.courseInfo,
    ...
    gotoPage(){
      comment.pageComment(1,8,this.courseId).then(response=>{
    ...
    addComment(){
       this.getTeacherName()
       comment.addComment(this.courseId,this.comment).then(response=>{
    ...
    userInfo(){
      ...
      if(userStr) {
        let  user= JSON.parse(userStr)
            console.log(user)
        this.comment.avatar=user.avatar
        this.comment.nickname=user.nickname
      }
    },
     getTeacherName(){
        teacher.getTeacherName(this.courseWebVo.teachername).then(response=>{
          this.comment.teacherId=response.data.data.id
        })
 }
 }
};
